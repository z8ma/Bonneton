...
if (isset($_POST['add_to_cart'])) {
    ...
    if (!isset($_SESSION['id'])) {
        $redirect = urlencode("/page_details_article.php?id=" . (int) ($_GET['id'] ?? 0));
            ...
            if ($resultat_afficher_com->num_rows > 0) {
                ...
                while ($row_com = $resultat_afficher_com->fetch_assoc()) {
                    ...
                    if (!empty($_SESSION['id'])) {
                        ...
                        $login_redirect = "/login.php?redirect=" . urlencode($_SERVER['REQUEST_URI'] ?? '/page_details_article.php');
